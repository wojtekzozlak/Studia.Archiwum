...
(** [fold f m a] computes [(f dN ... (f d1 a)...)], where [d1 ... dN]
    are the associated values of all bindings in [m].  The order in
    which the associated values are presented to [f] is
    unspecified. *)
