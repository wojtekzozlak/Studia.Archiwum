...
class FilterOperation : public ::google::protobuf::Message {
 public:
  ...
  inline const ::Expression& expression(int index) const;
  inline ::Expression* mutable_expression(int index);
  inline ::Expression* add_expression();
  inline const ::google::protobuf::RepeatedPtrField< ::Expression >&
      expression() const;
  inline ::google::protobuf::RepeatedPtrField< ::Expression >*
      mutable_expression();
 ...
 private:
  ...
  ::Operation* source_;
  ::google::protobuf::RepeatedPtrField< ::Expression > expression_;
...
// repeated .Expression expression = 2;
inline int FilterOperation::expression_size() const {
  return expression_.size();
}
inline void FilterOperation::clear_expression() {
  expression_.Clear();
}
inline const ::Expression& FilterOperation::expression(int index) const {
  return expression_.Get(index);
}
inline ::Expression* FilterOperation::mutable_expression(int index) {
  return expression_.Mutable(index);
}
inline ::Expression* FilterOperation::add_expression() {
  return expression_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::Expression >&
FilterOperation::expression() const {
  return expression_;
}
inline ::google::protobuf::RepeatedPtrField< ::Expression >*
FilterOperation::mutable_expression() {
  return &expression_;
}
