...
./compile.sh server_poll 100
time ./run.sh 6666 100 1 1 server_poll &> /dev/null
echo ""
...
echo "Testing server_poll..."
./compile.sh server_poll 100
time ./run.sh 6667 100 10 1 server_poll &> /dev/null
echo ""
echo "Testing server_libevent_no_mutex..."
./compile.sh server_libevent_no_mutex 100
...
echo ""
echo "Testing server_poll..."
./compile.sh server_poll 500
time ./run.sh 6668 500 10 1 server_poll &> /dev/null
echo ""
echo "Testing server_libevent_no_mutex..."
...
echo "Testing server_poll..."
./compile.sh server_poll 500
time ./run.sh 6669 500 100 1 server_poll &> /dev/null
echo ""
echo "Testing server_libevent_no_mutex..."
./compile.sh server_libevent_no_mutex 500
...
echo ""
echo "Testing server_poll..."
./compile.sh server_poll 1000
time ./run.sh 6670 1000 10 1 server_poll &> /dev/null
echo ""
echo "Testing server_libevent_no_mutex..."
...
echo "Testing server_poll..."
./compile.sh server_poll 1000
time ./run.sh 6671 1000 10 1 server_poll &> /dev/null
echo ""
echo "Testing server_libevent_no_mutex..."
./compile.sh server_libevent_no_mutex 1000
time ./run.sh 6671 1000 10 1 server_libevent_no_mutex &> /dev/null
echo ""
echo "Testing server_fork..."
./compile.sh server_fork 1000
time ./run.sh 6671 1000 10 1 server_fork &> /dev/null
echo ""
echo "--------"
echo ""
