...
SRC = main.c lcd.c keyboard.c editor.c 
...
CFLAGS =  -std=gnu99 -O2 -gstabs -Wa,-adhlns=$(<:.c=.lst) -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums $(patsubst %,-I%,$(EXTRAINCDIRS)) -Wall -Wstrict-prototypes
